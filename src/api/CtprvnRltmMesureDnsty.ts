...
export const CtprvnRltmMesureDnsty  = async (sidoName:string) => {
    ...
    // const url = baseUrl+'/B552584/ArpltnInforInqireSvc/getCtprvnRltmMesureDnsty?sidoName='+name+'&pageNo=1&numOfRows=100&returnType=json&serviceKey=LFz9dGOxxxoxURk2A8NOe%2BtaBYrx8CyRSTixm0A46pa3tC%2Bwr2VwdO7O3Bpmt46s45nRukeFQfqA12oWocpDqH%2B9A%3D%3D&ver=1.0';
    try{
